...
#define LAYOUT_LAYER_FUNCTION                                                                          \
    ...
    _______, KC_F12,  KC_F7,  KC_F8,  KC_F9,KC_PSCR,  KC_BSPC,KC_UNDO, KC_SPC,KC_SLSH,KC_QUOT,_______, \
...
#define LAYOUT_LAYER_NUMERAL                                                                           \
    ________________KEYB_CTRL_ROW_L________________,  ________________KEYB_CTRL_ROW_R________________, \
    _______,KC_LBRC,   KC_7,   KC_8,   KC_9,KC_RBRC,  KC_BSPC,KC_UNDO, KC_SPC,KC_SLSH,KC_QUOT,_______, \
...
#define LAYOUT_LAYER_SYMBOLS                                                                           \
    ________________KEYB_CTRL_ROW_L________________,  ________________KEYB_CTRL_ROW_R________________, \
    _______,KC_LCBR,KC_AMPR,KC_ASTR,KC_LPRN,KC_RCBR,  KC_BSPC,KC_UNDO, KC_SPC,KC_SLSH,KC_QUOT,_______, \
